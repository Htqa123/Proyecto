  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box flipped">
        ...
        <input type="hidden" id="persId" name="persId" value="<?= $data['persId']; ?>">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-lock"></i>Recuperar Contraseña?</h3>
          <div class="form-group">
            <input id="txtPassword" name="txtPassword" class="form-control" type="email" placeholder="Nueva Contraseña" required>
          </div>
          <div class="form-group">
            <input id="txtPasswordConfirm" name="txtPasswordConfirm" class="form-control" type="email" placeholder="Confirmar Contraseña" required>
          </div>
